...
export default function UserActivitiesPage({ params }: { params: { address: string } }) {
    const [searchQuery, setSearchQuery] = useState("")
    const [activityTypeFilter, setActivityTypeFilter] = useState("all")

    const { activities, loading, loadingMore, error, hasMore, loadMore, refresh } = useUserActivities(params.address, 20);
    ...
    return (
        <div className="min-h-screen">
            <main className="container mx-auto px-4 py-8 md:py-12 space-y-8 md:space-y-10">
                ...
                <div className="text-center space-y-4 md:space-y-6 max-w-4xl mx-auto">
                    ...
                    <div className="flex items-center justify-center gap-2 text-muted-foreground">
                        ...
                        <code className="text-sm font-mono bg-muted/50 px-3 py-1 rounded">
                    ...
                    {loading && !loadingMore && activities.length === 0 ? (
                            ...
                            <div className="p-8 md:p-12 text-center space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        {activities.length === 0
                                            ? "This wallet address has no recorded activities on the Mediolano Protocol yet."
                        ...
                        <>
                            ...
                            {!hasMore && activities.length > 0 && (
                                <p className="text-center text-muted-foreground text-sm pt-8">You have reached the end of the activity history.</p>
                            )}
                        </>
                    )}
                </div>
