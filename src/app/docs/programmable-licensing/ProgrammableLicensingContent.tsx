                            ...
                            <section id="decentralized-metadata" className="mb-20 scroll-mt-32">
                                ...
                                <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-muted-foreground">
                                    <p className="leading-relaxed mb-6">
                                        When an IP asset is minted using the Mediolano Medialane, the licensing terms are not stored on a centralized server. Instead, they are embedded directly into the asset's metadata, which is stored on decentralized storage networks like IPFS or Arweave.
                                    </p>
                            ...
                            <section id="ip-type" className="mb-20 scroll-mt-32">
                                ...
                                <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-muted-foreground">
                                    ...
                                    <div className="bg-muted/20 p-4 rounded-xl border-l-4 border-indigo-500">
                                        ...
                                        <p className="text-sm">
                                            Developers can propose and deploy new IP Type Templates via the DAO. Once approved, these templates become available to all users in the Medialane DApp.
                                        </p>
                                    </div>
                                </div>
                            </section>
