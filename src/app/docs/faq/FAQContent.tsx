                        ...
                        <div className="backdrop-blur-xl bg-background/40 border border-border/40 shadow-2xl rounded-3xl p-8 md:p-12 md:pb-24 overflow-hidden relative">
                            ...
                            <section id="creators" className="mb-20 scroll-mt-32">
                                <div className="flex items-center space-x-4 mb-8">
                                    ...
                                    <h2 className="text-3xl font-semibold tracking-tight">Medialane</h2>
                                </div>
                                <Accordion type="single" collapsible className="w-full">
                            ...
                            <section id="fees" className="mb-20 scroll-mt-32">
                                ...
                                <Accordion type="single" collapsible className="w-full">
                                    <AccordionItem value="item-5">
                                        <AccordionTrigger>Does it cost money to use Medialane or Mediolano Protocol?</AccordionTrigger>
                                        <AccordionContent>
                                            The Mediolano protocol and Medialane charges **zero fees**. You only pay the network gas fees required by Starknet, which are extremely low (typically cents).
                                        </AccordionContent>
                                    </AccordionItem>
