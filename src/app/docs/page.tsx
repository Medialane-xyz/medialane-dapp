...
export const metadata: Metadata = {
    title: "Documentation | Medialane",
    description: "The definitive guide to Mediolano Medialane. Explore the DApp, developer tools, protocol architecture, and DAO governance.",
    openGraph: {
        title: "Documentation | Medialane",
        description: "Explore the protocol, build with our tools, or participate in Mediolano DAO.",
        url: 'https://dapp.medialane.xyz/docs',
        siteName: 'Medialane',
        images: [
            {
                url: '/app-card.jpg',
