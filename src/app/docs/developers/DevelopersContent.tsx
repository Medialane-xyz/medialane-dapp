                            ...
                            <section id="open-source" className="mb-20 scroll-mt-32">
                                ...
                                <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-muted-foreground">
                                    <p className="leading-relaxed mb-6">
                                        You can find the source code for the Mediolano on GitHub. It is open source and available for anyone to use, modify, and contribute to. The Mediolano Medialane dapp is fully permissionless and can be run locally or deployed independently to create your own instance.
                                    </p>
